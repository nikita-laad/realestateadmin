...
import InquiryCreateLogic from './InquiryCreateLogic';
import { Link } from 'react-router-dom';

const InquiryCreate = () => {
  //Messages 
  const {enter_name, submit, cancel, name, email, enter_email, mobile, enter_mobile} = CommonMessage;
  const {add_a_new_inquiry, property, write_message, select_property, message} = InquiryMessages;
  //  End
  // Logic function
  const{handleSubmit, handleChange, Status, path,propertyLoader, loader, errors, properties, formValues} =InquiryCreateLogic()
  // End
  return (
    <>
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6">
                <div className="form-group mb-2">
                  ...
                  <input type="email" className="form-control form-control-user" name="email" placeholder={enter_email} onChange={handleChange}/>
              ...
              <div className="col-lg-6 col-md-6">
                <div className="form-group mb-2">
                  <label>{message}</label>
                  <textarea type="text" className="form-control form-control-user" name="message" placeholder={write_message} onChange={handleChange}></textarea>
