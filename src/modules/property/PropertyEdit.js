...
const PropertyEdit = () => {
  ...
  const {edit_property, price, location, squareFeet, garage, bedrooms, bathrooms, propertyRealtor, enter_price, enter_location, enter_square_feet, enter_garage, enter_bedrooms, enter_bathrooms, select_property_realtor} = PropertyMessage;
  return (
    <>
